...
?> <main><div class="container"><div class="row ajuda"><div class="col-sm-12 margin-default"><img src="img/doacao.png" alt="Psicologia" class="img-thumbnail"></div><div class="col-sm-12 margin-default"><h2 class="title-page" style="text-align: center;">“Os cabelos podem cair, mas ainda sobrará um fio. De esperança”</h2></div><div class="col-sm-12"><div class="card card-doacao"><p style="text-align: center;">Doando o valor referente ao pedágio de uma viagem,<br>você contribuirá para que nossas crianças deem mais um passo em direção à cura.</p><div class="card-body"><form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST"><button name="tipo" value="0" class="btn btn-lg btn-doacao">Doação Pontual</button> <button name="tipo" value="1" class="btn btn-lg btn-doacao">Doação Mensal</button></form></div> <?php
				  		$tipo = $_POST["tipo"];				  			
