...
?> <main><div class="container-fluid"><div class="row"><div id="carouselExampleControls" class="carousel slide" data-ride="carousel"><div class="carousel-inner"> <?php 		
				 ...
				 ?> <div class="carousel-item <?php if($count == 0) echo 'active'; ?>" data-interval="10000"><a href="<?php echo $banner->link; ?>"><img src="img/slides/<?php echo $banner->img; ?>" class="d-block w-100" alt="..."></a></div> <?php $count++; } ?> <?php } ?> </div><a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev"><span class="carousel-control-prev-icon" aria-hidden="true"></span> <span class="sr-only">Previous</span> </a><a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next"><span class="carousel-control-next-icon" aria-hidden="true"></span> <span class="sr-only">Next</span></a></div></div><!-- row --></div><!-- container--><div class="container-fluid video"><div class="row"><div class="col-sm-12"><h3 class="title-page" style="text-align: center;">Conheça mais sobre os projetos e serviços oferecidos pelo GACC</h3></div><div class="col-sm-12 media"><iframe width="560" height="315" src="https://www.youtube.com/embed/KV16f_tXMdU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div><!--col-sm-12--></div></div><div class="container"><div class="col-sm-8"><h2 class="title">Últimas notícias</h2><p class="border-news"></p><div class="row"> <?php								
				if ($noticias && $noticias->num_rows > 0) {
					while($news = $noticias->fetch_object()) {	
			?> <div class="col-sm-6 news"><div class="card" style="width: 20rem;"><img src="img/noticias/<?php echo $news->img; ?>" class="card-img-top" alt="..."><div class="card-body"><h5 class="card-title"><?php echo $news->titulo; ?></h5><p class="card-text"><?php echo nl2br (substr ($news->descricao, 0, 65)); ?> <a href="noticia-post.php?id=<?php echo $news->id_noticia; ?>">[...]</a></p></div></div><!-- card--></div><!-- col-sm-6--> <?php } ?> <?php } ?> <div class="col-sm-11 btns news"><a href="noticias.php" class="btn btn-default">Ver todas as notícias</a></div></div><!-- row --></div><!-- col-sm-8--><div class="col-sm-4"><div class="col-sm-12"><h2 class="title-blog">Blog</h2><p class="border-blog"></p><div class="card blog-card" style="width: 20rem; height: 329px;"><div class="card-body"> <?php								
							if ($blog && $blog->num_rows > 0) {
					  			while($post = $blog->fetch_object()) {	
				 		?> <div class="row blog"><div class="col-sm-5"><img src="img/blog/<?php echo $post->img; ?>"></div><div class="col-sm-7"><p class="card-text"><a href="post.php?id=<?php echo $post->id_blog; ?>"> <?php echo nl2br (substr ($post->nome, 0, 35)); ?> ...</a></p></div></div> <?php } ?> <?php } ?> </div></div><div class="col-sm-12 btns"><a href="blog.php" class="btn btn-blog">Acessar Blog</a></div></div><!-- col-sm-4--></div><!-- col-sm-4--></div><!-- row --.
	</div><!-- container --></main> <?php
