...
?> <main><div class="container"><div class="row history"> <?php								
		 	...
		 	?> <div class="col-sm-6 margin-default"><h1 class="title-page"><?php echo $post->titulo; ?></h1></div><div class="col-sm-3 margin-default"><p class="card-title headline-sub" style="text-align: right; padding: 20px 0;"><?php echo $post->categoria; ?> Publicado em <?php if($post->data_publicacao != null) {$timestamp = strtotime($post->data_publicacao); echo date('d/m/Y', $timestamp);} else {echo 'Sem data';} ?></p></div><div class="col-sm-9"><p><?php echo nl2br (substr ($post->descricao, 0)); ?></p><p><img class="blog-img" src="img/noticias/<?php echo $post->img; ?>"></p></div> <?php } ?> <?php } ?> <div class="col-sm-3"><h4 class="title-page">Outras notícias</h4><div class="card blog-card" style="width: 20rem;"><div class="card-body"> <?php								
