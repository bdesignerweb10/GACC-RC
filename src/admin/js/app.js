...
// BEGIN LOGIN (login.php)
	...
	$('#btn-add-noticia').click(function(e) {
		e.preventDefault();

		$('.maintable').hide();
		$('.mainform').show();

		$('#btn-salvar-noticia').data('id', null);
    	$('#btn-salvar-noticia').data('act', 'add');
    ...
    $('#btn-voltar-noticia').click(function(e) {
		e.preventDefault();
    ...
    $("#form-noticia").submit(function(e) {
		...
		var id = $('#btn-salvar-noticia').data('id');
    	var act = $('#btn-salvar-noticia').data('act');

    	if(act == "edit") {
    		var url = "acts/acts.noticias.php?act=" + act + "&id=" + id;
    	}
    	else {
    		var url = "acts/acts.noticias.php?act=" + act;    		
    	}
	...
	$('.btn-edit-noticia').click(function(e) {
		e.preventDefault();
		...
		$.ajax({
			type: "POST",
			url: "acts/acts.noticias.php?act=showupd&id=" + id,
			success: function(data)		
			{
				try {
					$('#loading').modal('hide');
					...
					if(retorno.succeed) {
				    	...
				    	$('#btn-salvar-noticia').data('act', 'edit');
				    	$('#btn-salvar-noticia').data('id', id);	    				
				    	...
				    	$('#btn-salvar-noticia').data('id', null);
				    	$('#btn-salvar-noticia').data('act', null);				    	
    ...
    $('.btn-del-noticia').click(function(e) {
		e.preventDefault();
		...
		$.ajax({
			type: "POST",
			url: "acts/acts.noticias.php?act=del&id=" + id,
			success: function(data)
			{
				try {
					$('#loading').modal('hide');
