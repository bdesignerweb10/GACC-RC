	...
	<div class="container">
		<div class="row blog">
			...
			<div class="col-sm-5">
				...
				<h5 class="card-title headline"><?php echo $dest->titulo; ?></h5>
				<p class="blog-text"><?php echo nl2br (substr ($dest->descricao, 0, 400)); ?> [...]</p>
				<p><a href="post.php?id=<?php echo $dest->id_blog; ?>" class="blog-link">Saiba Mais</a></p>
			</div><!-- col-sm-5-->
				<?php } ?> 
			<?php } ?>
		</div><!-- row-->		
