<?php
	...
	$id = $_GET["id"];
	$eventos = $conn->query("select * from tbl_eventos where ativo = 1 order by realizado") or trigger_error($conn->error);
?>
<main>
	<div class="container">
		<div class="row ajuda">
			<?php								
		 	...
		 	<div class="col-sm-4 margin-default">
				<img src="img/eventos/<?php echo $ev->img; ?>" alt="..." class="img-thumbnail" style="width: 315px;">
			</div>
			<div class="col-sm-8 margin-default">
				...
				<a href="evento.php?id=<?php echo $ev->id_evento; ?>" class="btn btn-participe" style="margin:10px 0;">Conferir evento</a>			
			</div>			
				<?php } ?> 
			<?php } ?>
		</div><!-- row-->		
